...
<form action="" name="insertForm" id="insertForm" method="POST">
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="mnName">
		</div>
	</div>
	<div class="form-group row">
		<label for="staticEmail" class="col-sm-2 col-form-label">URL</label>
		<div class="col-sm-10">
			<input type="text" class="form-control" name="mnUrl"
			>
		</div>
	</div>
	<div class="form-group row">
		<label for="staticEmail" class="col-sm-2 col-form-label">공개여부</label>
		<div class="col-sm-10">
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			...
			<input type="hidden" name="mnPrntName" value="">
			<input type="hidden" name="mnIdx" value="">
		</div>
	</div>
</form>
<div class="text-right">
	<button type="boutton" class="btn btn-info" onclick="menuInsert()">저장</button>
	<button type="boutton" class="btn btn-danger" onclick="menuEsc()">취소</button>
</div>
