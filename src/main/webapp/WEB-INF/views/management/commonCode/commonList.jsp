						...
						<div class="col-md-10">
							<div class="panel panel-headline">
								...
								<div class="panel-body">
									<form action="/spring/commonList.do" id="commonSearchForm">
									<div class="col-md-2">
											...
											<nav aria-label="Page navigation example" align="center">
												<ul class="pagination">
													<c:if test="${startPage+0 > 1}">
														<li class="page-item">
															<a class="page-link" href="/spring/commonList.do?selectPageNum="+${prevPage}>	
													...
													<c:forEach var="p" varStatus="status" begin="${startPage}" end="${endPage}">
														<li class="page-item"><a class="page-link" href="/spring/commonList.do?selectPageNum="+${status.count}>${status.count}</a></li>
													</c:forEach>
													<c:if test="${endPage+0 < allPageNum+0}">
														<li class="page-item">
															<a class="page-link" href="/spring/commonList.do?selectPageNum="+${nextPage} aria-label="Next">
